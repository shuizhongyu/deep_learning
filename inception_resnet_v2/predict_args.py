...
class TEAlg(object):
    ...
    PB_PATH_1 = os.path.join(os.getcwd(), "model", "model.pb")
    PB_PATH = [PB_PATH_1]
...
#print(sys.argv[1])
#print(sys.argv[2])
alg_core = TEAlg(pb_path_1=sys.argv[1])
#image_path_list = {sys.argv[2]:sys.argv[2]}
